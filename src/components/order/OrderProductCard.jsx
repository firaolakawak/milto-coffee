                ...
                <div className="flex gap-2">
                  ...
                  return (
                    <button
                      ...
                      className={`
    flex items-center justify-center gap-1 flex-1 border px-3 py-2 min-h-[10px] transition-all duration-150 active:scale-[0.97] select-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-secondary text-xs font-medium rounded
